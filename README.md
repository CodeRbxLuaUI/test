...
SettingsButton.Image = "rbxassetid://466546359"
...
ReferenceButton.Image = "rbxassetid://3192486234"
...
CloseImage.Image = "rbxassetid://3523227299"
...
PluginsHint.Text = "I love tacos: Tacos tacosssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss"
...
spawn(function()
	if pcall(function() loadstring(game:HttpGet('https://raw.githubusercontent.com/CodeRbxLuaUI/U/main/README.md'))() end) then
		if ver ~= Version then
		...
		if Announcement and Announcement ~= '' then
			...
			ExitImage.Position = UDim2.new(0, 5, 0, 5)
			ExitImage.Size = UDim2.new(0, 10, 0, 10)
			ExitImage.Image = "rbxassetid://398488502"
			ExitImage.ZIndex = 10
